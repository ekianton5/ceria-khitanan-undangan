  ...
  return (
    <section id="rsvp" className="py-20 bg-background">
      ...
      <div className="bg-white/10 rounded-lg p-4 text-center">
                <p className="text-lg md:text-xl font-semibold tracking-tight leading-tight">Kel. Bpk. Lala Sukmara (Lalan)</p>
    ...
    <div className="mb-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-stretch max-w-4xl mx-auto">
              ...
              <div className="bg-white/10 rounded-lg p-6 text-center md:col-start-1 md:justify-self-end flex flex-col justify-center items-center h-full md:max-w-xs">
                <p className="text-lg md:text-xl font-semibold tracking-tight leading-tight">Kel. Besar Bpk. Jajang Permana</p>
                <p className="text-sm opacity-90 mt-2 leading-relaxed">Ibu Edah Jubaedah</p>
              </div>
              ...
              <div className="bg-white/10 rounded-lg p-6 text-center md:col-start-3 md:justify-self-start flex flex-col justify-center items-center h-full md:max-w-xs">
                <p className="text-lg md:text-xl font-semibold tracking-tight leading-tight">Kel. Besar Bpk. Memed</p>
          ...
          <div className="max-w-4xl mx-auto mt-8 px-4">
              <h3 className="text-center  md:text-lg font-semibold mb-6">Turut Mengundang :</h3>
                    ...
                    <>
                      <div className="w-full md:col-start-1 md:col-span-1">
                        <div className="space-y-3">
                          {left.map((text, idx) => (
                            <div className="grid grid-cols-[32px_1fr] gap-3 items-start" key={`l-${idx}`}>
                              <div className="text-sm text-gray-700 font-medium">{idx + 1}.</div>
                      ...
                      <div className="w-full md:col-start-3 md:col-span-1">
                        <div className="space-y-3">
                          {right.map((text, idx) => (
                            <div className="grid grid-cols-[32px_1fr] gap-3 items-start" key={`r-${idx}`}>
                              <div className="text-sm text-gray-700 font-medium">{mid + idx + 1}.</div>
                              <div className="text-sm text-gray-700 leading-relaxed">{text}</div>
                            </div>
                          ))}
                        </div>
